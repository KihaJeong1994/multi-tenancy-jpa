...
@EnableJpaRepositories(
        basePackages = { "com.example.multitenenttest.repository.tenant" },
...
public class TenantPersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean tenantEntityManagerFactory(
        ...
        properties.put(AvailableSettings.MULTI_TENANT, MultiTenancyStrategy.SCHEMA); // choose multi tenancy strategy
